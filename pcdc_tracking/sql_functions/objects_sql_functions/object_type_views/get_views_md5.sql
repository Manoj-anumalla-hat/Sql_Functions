CREATE OR REPLACE FUNCTION pdcd_schema.get_views_md5(
...
BEGIN
    ...
    FROM pdcd_schema.get_view_details(p_table_list) gtd
    ORDER BY gtd.schema_name, gtd.view_name;
END;
$function$;

-- SELECT * FROM pdcd_schema.get_views_md5(ARRAY['pdcd_test']);